    ...
    def _setup_speed_parameters(self):
        ...
        return {
            1: {
                ...
                'period_time': [400, 0.5, 0.02],  # [period_ms, dsp_ratio, y_swap_amplitude]
                'x_amp': -0.01,   # Ограничивается до ±0.01 или ±0.015 в зависимости от направления
                'y_amp': 0.012,   # Ограничивается до ±0.01 или ±0.012 в зависимости от направления
                'angle_amp': 10.0,  # Ограничивается до ±10 градусов
                ...
                'gait_base': {
                    ...
                    'z_swap_amplitude': 0.002,  # амплитуда подъема ноги
                    'init_y_offset': 0.03,  # РАЗДВИЖЕНИЕ НОГ
                    'body_height': 0.04,  # Может меняться до 0 в зависимости от движения
                    'init_x_offset': 0.0,   # смещение корпуса влево и вправо
                    'init_roll_offset': 0.0,  # Может меняться до 3-5 в зависимости от движения
                    'init_pitch_offset': -9.0,  # угол наклона корпуса вперед и назад
            ...
            2: {
                # Low Speed
                'period_time': [280, 0.48, 0.02],  # [period_ms, dsp_ratio, y_swap_amplitude]
                'x_amp': 0.01,   # Ограничивается до ±0.01 или ±0.015 в зависимости от направления
                'y_amp': 0.012,   # Ограничивается до ±0.01 или ±0.012 в зависимости от направления
                'angle_amp': 10.0,  # Ограничивается до ±10 градусов
                'z_move_amplitude': 0.025,
                ...
                'gait_base': {
                    #'dsp_ratio': 0.5,  # доля времени в цикле, когда обе ноги на земле
                    'step_fb_ratio': 0.090,  # дистанция шага вперед и назад
                    #'y_swap_amplitude': 0.015,  # амплитуда качания ноги влево и вправо
                    'z_swap_amplitude': 0.002,  # амплитуда подъема ноги
                    'init_y_offset': 0.03,  # РАЗДВИЖЕНИЕ НОГ
                    'body_height': 0.04,  # Может меняться до 0 в зависимости от движения
                    'init_x_offset': 0.0,   # смещение корпуса влево и вправо
                    'init_roll_offset': 0.0,  # Может меняться до 3-5 в зависимости от движения
                    'init_pitch_offset': -7.0,  # угол наклона корпуса вперед и назад
                    'hip_pitch_offset': 1.0, # угол наклона бедра вперед и назад
                    'pelvis_offset': 5.0, #расстояние между поворотами тазобедренных суставов влево и вправо
                    'step_height': 0.026
                }
